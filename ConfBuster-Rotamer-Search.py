...
def main(argv):
    ...
    try:
        ...
        print 'ConfBuster-Rotamer-Search.py -i inputfile in mol2 [mandatory] -g # of generations [100] -e accepted delta E in kcal/mol [50] -d output directory [automatic] -f format of outputted molecules [xyz,mol2(default)]'
        sys.exit(2)
